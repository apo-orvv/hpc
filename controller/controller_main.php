...
class Controller
{
	...
	public function invoke()
	{
		...
		if (isset($_GET['hpcresource'])) {
			...
			if (strcmp($mypage, "gws") == 0) {
				include "controller/controller_gws.php";
			}
			if (strcmp($mypage, "logparserA") == 0) {
				include "controller/controller_parserA.php";
			}
			if (strcmp($mypage, "viewlpA") == 0) {
				include "controller/controller_viewlpA.php";
			}
			if (strcmp($mypage, "logparserC") == 0) {
				include "controller/controller_parserC.php";
			}
			if (strcmp($mypage, "viewlpC") == 0) {
				include "controller/controller_viewlpC.php";
			}
			if (strcmp($mypage, "lpANSYS") == 0) {
				include "controller/controller_lpANSYS.php";
			}
			if (strcmp($mypage, "viewlpANSYS") == 0) {
				include "controller/controller_viewlpANSYS.php";
			}
