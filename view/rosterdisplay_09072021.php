...
function display_heading($pat,$days)
{
//print_r($pat);
...
function display_roster($cpat,$cmem,$days,$LA,$dm)
{
foreach($LA as $leave)
{
$day=date("d");
...
if($updateflag==0){
	...
	<h2 style='text-align: center;font-family: Times New Roman; color: chocolate;'>
	Computing System Section (CSS) CD : RTC Duty Roster : <u>".date("F",mktime(0,0,0,$m))." ".$y."</u></h2></th></tr>";

?>
<tr class="rostertable" >

<th class="rostertable" width='10%' style='color: black;' > <input name='b_print' type='button' onClick="printdiv('div_print');" value=" Print" </th>
<?php echo"<th class='rostertable' width='10%' style='color: black;' >". date("D j-m-Y ")." </th>"; ?>
 <?php for ($i=0; $i<$Iscnt; $i++) { echo '<th class="rostertable" style="background-color:#FFD700;color:black">'. $Ishiftmem[$i].' </th>'; } ?> 

<?php for ($i=0; $i<$IIscnt; $i++) { echo '<th class="rostertable" style="background-color:#FFB6C1;color:black">'. $IIshiftmem[$i].' </th>'; } ?> 

<?php for ($i=0; $i<$IIIscnt; $i++) { echo '<th class="rostertable" style="background-color:#87CEFA;color:black">'. $IIIshiftmem[$i].' </th>'; } ?>
</tr>
</table>
<?php } ?>
<div id="div_print">
...
<select name="month" size="1" style="cursor: pointer" id="select_month">
    <option value="1" <?php if($selected_month == "01"){ print "selected='selected'"; } ?> >Jan</option>
    <option value="2" <?php if($selected_month == "02"){ print "selected='selected'"; } ?> >Feb</option>
    <option value="3" <?php if($selected_month == "03"){ print "selected='selected'"; } ?> >Mar</option>
	<option value="4" <?php if($selected_month == "04"){ print "selected='selected'"; } ?> >Apr</option>
	<option value="5" <?php if($selected_month == "05"){ print "selected='selected'"; } ?> >May</option>
	<option value="6" <?php if($selected_month == "06"){ print "selected='selected'"; } ?> >Jun</option>
	<option value="7" <?php if($selected_month == "07"){ print "selected='selected'"; } ?> >Jul</option>
	<option value="8" <?php if($selected_month == "08"){ print "selected='selected'"; } ?> >Aug</option>
	<option value="9" <?php if($selected_month == "09"){ print "selected='selected'"; } ?> >Sep</option>
	<option value="10" <?php if($selected_month == "10"){ print "selected='selected'"; } ?> >Oct</option>
	<option value="11" <?php if($selected_month == "11"){ print "selected='selected'"; } ?> >Nov</option>
	<option value="12" <?php if($selected_month == "12"){ print "selected='selected'"; } ?> >Dec</option>
    </select>

<select name="year" size="1" style="cursor: pointer" id="select_year">
    <option value="2017" <?php if($selected_year == "2017"){ echo "selected='selected'"; } ?> >2017</option>
	<option value="2018" <?php if($selected_year == "2018"){ echo "selected='selected'"; } ?> >2018</option>
    <option value="2019" <?php if($selected_year == "2019"){ echo "selected='selected'"; } ?> >2019</option>
    <option value="2020" <?php if($selected_year == "2020"){ print "selected='selected'"; } ?> >2020</option>
	<option value="2021" <?php if($selected_year == "2021"){ print "selected='selected'"; } ?> >2021</option>
	<option value="2022" <?php if($selected_year == "2022"){ print "selected='selected'"; } ?> >2022</option>
	<option value="2023" <?php if($selected_year == "2023"){ print "selected='selected'"; } ?> >2023</option>
	<option value="2024" <?php if($selected_year == "2024"){ print "selected='selected'"; } ?> >2024</option>
	<option value="2025" <?php if($selected_year == "2025"){ print "selected='selected'"; } ?> >2025</option>
	<option value="2026" <?php if($selected_year == "2026"){ print "selected='selected'"; } ?> >2026</option>
     </select><input type="submit" name="fetch" value="Fetch" id="month_year_submit">

</th>
<th class="rostertable" style="background-color:#32cd32"><?php echo "".date("M",mktime(0,0,0,$m,1)) ." - $y". ""; ?></th> <?php

//echo $days;
for ($i=1; $i<=$days; $i++) {

if ($i==$htdate){
echo "<th class='rostertable' style='background-color:#A32b2b;border:1' >"; echo $i; } if ($i!= $htdate){ echo "<th class='rostertable' style='background-color:#11cc00;border:1' >"; echo $i; }
...
echo "</tr>
<tr class='rostertable'>";
echo"<th class='rostertable' style='background-color:#2F4F4F;border:1'>Crew A</th> <th class='rostertable' style='background-color:#2F4F4F'>Icno</th>";
...
echo" <tr class='rostertable'> <th class='rostertable' style='background-color:#2F4F4F'>Crew B</th> <th class='rostertable' style='background-color:#2F4F4F'>Icno</th>";
...
echo"<tr class='rostertable'> <th class='rostertable' style='background-color:#2F4F4F'>Crew C</th> <th class='rostertable' style='background-color:#2F4F4F'>Icno</th>";
...
echo"<tr class='rostertable'> <th class='rostertable' style='background-color:#2F4F4F'>Crew D</th> <th class='rostertable' style='background-color:#2F4F4F'>Icno</th>";
...
echo"<tr class='rostertable'> <th class='rostertable' style='background-color:#2F4F4F'>General</th> <th class='rostertable' style='background-color:#2F4F4F'>Icno</th>";
display_heading($gH['c_pattern'],$days);
for($i=1;$i<=$cnt;$i++)
{
if($cname[$i]=='G'){
display_roster($rA[$i]['c_pattern'],$cA[$i],$days,$LA[$i],$m);
