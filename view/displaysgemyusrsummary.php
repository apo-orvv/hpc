...
<?php
echo "<h1>Displaying Info for user $username</h1>";
echo "<table id='jobtable' class='display' align='center' cellpadding='1' cellspacing='0'  border=1><thead><tr><th>Year</th><th>Number of Jobs</th><th>Slots</th><th>Wall Clock Time (HRS)</th><th>CPU Usage</th><th>Memory Usage</th></tr></thead><tbody>";
//echo "<tfoot><tr><th>Log Time </th><th>Server Name</th><th>Message</th></tr></tfoot><tbody>";
foreach($yearsumm as $job){
$wallclk=$job[2]/3600;
echo "<tr><td>$job[5]</td><td>$job[0]</td><td>$job[1]</td><td>$wallclk</td><td>$job[3]</td><td>$job[4]</td></tr>";
}
echo "</tbody></table>";
?>
<script>
