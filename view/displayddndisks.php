...
echo "<h4>DDN Disk Details for  $systemname</h4>";
...
echo "<br/><br/>";
echo "<table id='ddntable' class='display' align='center' cellpadding='1' cellspacing='0'  border=1><thead><tr><th>Time of Monitoring </th><th>Controller IP</th><th>Slot</th><th>Vendor</th><th>Productid</th><th>Type</th><th>Capacity (GB) / RPM / Revision</th><th>Serial No</th><th>Pool</th><th>Health</th></tr></thead><tbody>";
foreach ($ddndisks as $ddn){
echo "<tr><td>$ddn[0]</td><td>$ddn[1]</td><td>$ddn[2]</td><td>$ddn[3]</td><td>$ddn[4]</td><td>$ddn[5]</td><td>$ddn[6] /$ddn[7] / $ddn[8]</td><td>$ddn[9]</td><td>$ddn[10]</td><td>$ddn[11]</td></tr>";
