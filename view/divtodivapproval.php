...
<tr> <input type="submit" name="divforward" value="Forward to Head, Computer Division">
 </thead>
</table>
...
<td>
<input type="checkbox" name="check_list[]" value="<?php echo htmlspecialchars($r['reqid']) ?>"> </td>
