...
<table  class='bordercollap' width='100%' border = "1" align='center' cellpadding='1' celspacing='0' bgcolor="#FFFFFF"> 
  ...
  <table  width='100%' align='center' cellpadding='1' cellspacing='0'     >
   <tr valign ='top' align='center'  >
       <td height="15" colspan="4" valign = "top" style="text-align:center;border:0" > <strong>  Workstation User Approval Form </strong>
       </td> 
   </tr>
   
   <tr valign ='top' align='center'  >
       <td height="15" colspan="4" valign = "top" style="text-align:center;border:0" > <strong> Enter User Request ID  </strong> <input name='wsreqid' type='text' maxlength='30' /> <input  type='submit' name='cfetch' value='Fetch User Details ' />
       </td> 
   </tr>
  <?php
