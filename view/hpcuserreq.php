...
function retrieveUser(str) {//loadXMLDoc() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      ...
      servers=user[9];
      document.getElementById("clusacct1").value = user[9];
      document.getElementById("homefldr1").value = user[10];
      document.getElementById("adacct1").value = user[14];
      if(user[1]!="")
      {
...
<table  class='bordercollap' width='100%' border = "1" align='center' cellpadding='1' celspacing='0' bgcolor="#FFFFFF">  
    <table  width='100%' align='center' cellpadding='1' cellspacing='0'>
        ...
        <tr  valign ='top' align='left'>
            <td width="24%" height="15" > Name <span class="style1">*</span></td>
            <td width="31%" height="15" align='left' ><b>
        ...
        <tr valign ='top' align='center' >
            ...
            <td height="15" align='left'>Sub Group</td>
            <td height="15" align='left'><b>
        ...
        <tr valign ='top' align='center' >
            ...
            <td height="15" align='left'> Section </td>
            <td height="15" align='left'><b>
        ...
        <tr valign ='top' align='center'>
            ...
            <td height="15" align='left' ><b>
                    <input name='clusacct'  id='clusacct' type='text' maxlength='100' value="<?php echo $_POST['clusacct']; ?>" readonly="readonly" hidden="hidden"/>
                    <input name='clusacct1'  id='clusacct1' type='text' maxlength='100' value="<?php echo $_POST['clusacct']; ?>" readonly="readonly" disabled="disabled"/>
                </b>
            </td>
            <td height="15" align='left'> User home group in cluster</td><!--Home folder location:</td>-->
            <td height="15" align='left'><b>
                    <input name='homefldr' id='homefldr' type='text' maxlength='12' onchange='validate(this.value)' value="<?php echo $_POST['homefldr']; ?>" readonly="readonly" hidden="hidden"/>
                    <input name='homefldr1' id='homefldr1' type='text' maxlength='12' onchange='validate(this.value)' value="<?php echo $_POST['homefldr']; ?>" readonly="readonly" disabled="disabled"/>
        ...
        <tr valign ='top' align='center'>
            ...
            <td height="15" align='left' ><b>
                    <input name='adacct'  id='adacct' type='text' maxlength='100' value="<?php echo $_POST['adacct']; ?>" readonly="readonly" hidden="hidden"/>
                    <input name='adacct1'  id='adacct1' type='text' maxlength='100' value="<?php echo $_POST['adacct']; ?>" readonly="readonly" disabled="disabled"/>
                </b>
            </td>
...
<tr valign ='middle' align='center' >
 <td align='left'style="border:0;"><br></td>
</tr>
<tr valign ='middle' align='center'>
    <td height="23" colspan="2" style="text-align:center"><strong><span class="style1"><i><u>Note:</u> Existing users of a cluster cannot apply for account in the same cluster again. </i></span></strong></td>
</tr>
<tr valign ='middle' align='center' >
