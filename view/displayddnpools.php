...
echo "<h4>DDN Pool Details for  $systemname</h4>";
...
echo "<br/><br/>";
echo "<table id='ddntable' class='display' align='center' cellpadding='1' cellspacing='0'  border=1><thead><tr><th>Time of Monitoring </th><th>Controller IP</th><th>Pool ID</th><th>Pool Name</th><th>Pool State</th><th>Chunk</th><th>RAID</th><th>Jobs</th></tr></thead><tbody>";
foreach ($ddndisks as $ddn){
echo "<tr><td>$ddn[0]</td><td>$ddn[1]</td><td>$ddn[2]</td><td>$ddn[3]</td><td>$ddn[4]</td><td>$ddn[5]</td><td>$ddn[6] </td><td>$ddn[7] </td></tr>";
