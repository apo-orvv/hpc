...
<?php
		$swname="COMSOL";
		$fname=array("ACDC","ACDCBATCH","CADIMPORT","CADIMPORTBATCH","CADREADER","CADREADERBATCH","CFD","CFDBATCH","CHEM","CHEMBATCH","ELECTRODEPOSITION","ELECTRODEPOSITIONBATCH","HEATTRANSFER", "HEATTRANSFERBATCH","LLAUTOCAD","CLIENTSERVER","CLUSTERNODE","COMSOL","COMSOLBATCH","COMSOLGUI");
