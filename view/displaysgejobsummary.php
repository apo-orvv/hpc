...
echo "<h3> $systemname Cluster Jobs: Process wise Summary</h3>";
...
echo "<table id='jobtable' class='display' align='center' cellpadding='1' cellspacing='0'  border=1><thead><tr><th>Process Name</th><th>Number of Jobs</th><th>Cores</th><th>Wall Clock Time (HRS)</th><th>CPU Usage (Seconds) </th><th>Memory Usage (Gbytes CPU Seconds)</th></tr></thead><tbody>";
...
$elapsed_time=array();
$i=0;
foreach($jobsumm as $job){
$wallclk=$job[2]/3600;
$wallclk=round($wallclk,2);
$job[3]=round($job[3],2);
$job[4]=round($job[4],2);

echo "<tr><td>$job[5]</a></td><td>$job[0]</td><td>$job[1]</td><td>$wallclk</td><td>$job[3]</td><td>$job[4]</td></tr>";
...
var subtitle = <?php echo $subtitle;?>; 
 $('#container').highcharts({
                ...
                title: {
                        ...
                        text: 'Neha Cluster Jobs - Cores Used/Process '
                },
 ...
 $('#container1').highcharts({
                ...
                title: {
                        ...
                        text: 'Neha Cluster Jobs - Jobs/Process '
                },
 ...
 $('#container2').highcharts({
                ...
                title: {
                        ...
                        text: 'Neha Cluster Jobs - Total Running Time (Hrs)/Process '
                },
