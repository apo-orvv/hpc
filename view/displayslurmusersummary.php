...
echo "<h4> $systemname Cluster Jobs: User wise Summary</h4>";
...
echo "<table id='jobtable' class='display' align='center' cellpadding='1' cellspacing='0'  border=1><thead><tr><th>User Name</th><th>Number of Jobs</th><th>Cores</th><th>Wall Clock Time (HRS)</th></tr></thead><tbody>";
...
echo "<tr><td><a href=\"index.php?hpcpage=systemdetails&systemname=$systemname&systemparam=User_Details&username=$job[3]\">$job[3]</a></td><td>$job[0]</td><td>$job[1]</td><td>$wallclk</td></tr>";
$myslot=array($job[3],$job[1]);
array_push($slots,$myslot);
$myjob=array($job[3],$job[0]);
array_push($numjobs,$myjob);
$mytime=array($job[3],$wallclk);
...
var subtitle = <?php echo $subtitle;?>; 
 $('#container').highcharts({
                ...
                title: {
                        ...
                        text: 'Ivy Cluster Jobs - CPU Cores Used/User '
                },
 ...
 $('#container1').highcharts({
                ...
                title: {
                        ...
                        text: 'Ivy Cluster Jobs - Jobs/User '
                },
 ...
 $('#container2').highcharts({
                ...
                title: {
                        ...
                        text: 'Ivy Cluster Jobs - Total Running Time (Hrs)/User '
                },
