...
echo "<tr><td>$job[0]</td><td>$job[1]</td><td><a href=\"index.php?hpcpage=systemdetails&systemname=Ivy&systemparam=User_Details&username=$job[2]\">$job[2] / $job[3]</a></td><td>$job[4]</td><td>$job[5]</td><td>$job[6]</td><td>$job[7]</td><td>$job[8]</td><td>$wallclk</td><td>$job[10]</td></tr>";
}
echo "</tbody></table>";
?>
<script>
