...
<thead>    
<tr>  
<td colspan="9" align='center' height="35px" bgcolor='#9999CC' ><strong> List of user requests for HPC Systems </strong> </td> 
</tr> </thead>
</table>
...
<thead> <tr bgcolor='' height="35px">
   <strong> <th width = '5%' > Request ID </th> </strong>
    <th width = '5%' ><strong>IC_No</strong> </th>
	 <th width = '10%'  ><strong>Name </strong> </th>
	  <th width = '10%' ><strong>Mail ID </strong> </th>
	  <th width = '5%'  ><strong>Group </strong></th>
	  <th width = '10%'  ><strong>Division </strong> </th>
    <th width = '10%' ><strong>Date Requested </strong>  </th>
	 <th width = '10%' ><strong>Date Created </strong> </th>
...
<td width = '5%' ><?php echo htmlspecialchars($r['reqid']); ?></td>
 <td width = '5%'> <a href="hpcuserprt?reqid=<?php echo htmlspecialchars($r['reqid']); ?>"> <?php echo htmlspecialchars($r['icno']); ?>  </a> </td>      
 <td width = '10%'><?php echo htmlspecialchars($r['user_name']); ?></td>
 <td width = '10%'><?php echo htmlspecialchars($r['mailid']); ?></td>
 <td width = '5%'><?php echo htmlspecialchars($r['igroup']); ?></td>
...
//endwhile;  
 ?> </td>
 <td width = '10%'><?php echo htmlspecialchars($r['hpcstat']); ?></td>
 </tr>
 <?php } ?>
 </tbody>								 												
</table>
