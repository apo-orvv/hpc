...
echo "<h3> $systemname Cluster Jobs: User wise Summary</h3>";
...
echo "<table id='jobtable' class='display' align='center' cellpadding='1' cellspacing='0'  border=1><thead><tr><th>User Name</th><th>Number of Jobs</th><th>Cores</th><th>Wall Clock Time (HRS)</th><th>CPU Usage (Seconds) </th><th>Memory Usage (Gbytes CPU Seconds)</th></tr></thead><tbody>";
...
var subtitle = <?php echo $subtitle;?>; 
 $('#container').highcharts({
                ...
                title: {
                        ...
                        text: 'Neha Cluster Jobs - Cores Used/User '
                },
 ...
 $('#container1').highcharts({
                ...
                title: {
                        ...
                        text: 'Neha Cluster Jobs - Jobs/User '
                },
 ...
 $('#container2').highcharts({
                ...
                title: {
                        ...
                        text: 'Neha Cluster Jobs - Total Running Time (Hrs)/User '
                },
