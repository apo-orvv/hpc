...
<tr>  
<td colspan="9" align='center' bgcolor='#9999CC'><strong> Monthly Shift change Report of RTC shift Members</strong> <input  type='submit' name='printall' value='print' onclick='printit()' /> </td>  
</tr> </thead>
<tr bgcolor=''>
    <td width = '10%'  > <strong> Sl.No.  </strong> </td> 
    <td width = '35%'  ><strong>  Employee Name  </strong> </td>
    <td width = '15%'  ><strong>  Action Type  </strong> </td>
