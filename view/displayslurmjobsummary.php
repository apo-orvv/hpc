...
echo "<table id='jobtable' class='display' align='center' cellpadding='1' cellspacing='0'  border=1><thead><tr><th>Job</th><th>Number of Jobs</th><th>Cores</th><th>Wall Clock Time (HRS)</th></tr></thead><tbody>";
...
echo "<tr><td>$job[3]</td><td>$job[0]</td><td>$job[1]</td><td>$wallclk</td></tr>";
...
var subtitle = <?php echo $subtitle;?>; 
 $('#container').highcharts({
                ...
                title: {
                        ...
                        text: 'Ivy Cluster Jobs - Cores Used/Process '
                },
 ...
 $('#container1').highcharts({
                ...
                title: {
                        ...
                        text: 'Ivy Cluster Jobs - Number of Jobs/Process '
                },
 ...
 $('#container2').highcharts({
                ...
                title: {
                        ...
                        text: 'Ivy Cluster Jobs - Total Running Time (Hrs)/Process '
                },
