...
<tr  valign ='top' align='left' >
    ...
    <input name='div'  id='tnam3' type='text' maxlength='30' value="<?php echo $_POST['div']; ?>"/>
      ...
      <option value="MCMFCG" <?php if($_POST['grp'] == "MC&MFCG") { echo "selected=\"selected\""; } ?>>MC&MFCG</option>
      ...
      <option value="RDTG" <?php if($_POST['grp'] == "RD&TG") { echo "selected=\"selected\""; } ?>>RD&TG</option>
      ...
      <option value="SQRMG" <?php if($_POST['grp'] == "SQ&RMG") { echo "selected=\"selected\""; } ?>>SQ&RMG</option>
