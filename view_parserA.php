...
class LogView
{
    ...
    public function displayData($data, $csvData)
    {
        ...
        <body>
            <p style="text-align: center;">Processed CSV file ready for download: <a href="' . $csvData . '">' . $csvData . '</a></p>
            ...
            <h1>LICENSES COUNT</h1>
                ...
                <script>
                    ...
                    for (var i = 0; i < licData.length; i++) {
                        ...
                        dataValues[date][feature] = licData[i]["SUM(Licenses)"];
                    }
